...
{id:'dashboard',label:'الرئيسية',path:'./dashboard.html',icon:navIcon('dashboard'),group:'الرئيسية',requiredPermissions:['dashboard.view'],showInSidebar:true,showInShortcutMenu:true,order:1},
{id:'attendance',label:'الحضور والانصراف',path:'./attendance.html',icon:navIcon('attendance'),group:'التشغيل اليومي',requiredPermissions:['attendance.view','attendance.view.self','attendance.view.department','attendance.view.all'],showInSidebar:true,showInShortcutMenu:true,order:10},
{id:'leaves',label:'الطلبات',path:'./leaves.html',icon:navIcon('requests'),group:'التشغيل اليومي',requiredPermissions:['leaves.view','requests.view.self','requests.view.department','requests.view.all'],showInSidebar:true,showInShortcutMenu:true,order:11},
{id:'shifts',label:'الشفتات',path:'./shifts.html',icon:navIcon('shifts'),group:'التشغيل اليومي',requiredPermissions:['shifts.view'],showInSidebar:true,showInShortcutMenu:false,order:12},
{id:'employees',label:'الموظفون',path:'./employees.html',icon:navIcon('employees'),group:'الموارد البشرية',requiredPermissions:['employees.view','employees.view.self'],showInSidebar:true,showInShortcutMenu:false,order:20},
...
{id:'salaries',label:'الرواتب',path:'./salaries.html',icon:navIcon('salaries'),group:'المالية',requiredPermissions:['salaries.view','finance.payroll_slips.view'],showInSidebar:true,showInShortcutMenu:true,order:30},
{id:'reports',label:'التقارير',path:'./reports.html',icon:navIcon('reports'),group:'التقارير',requiredPermissions:['reports.view','reports.view.self','reports.view.department','reports.view.all'],showInSidebar:true,showInShortcutMenu:true,order:40},
{id:'announcements',label:'الإعلانات',path:'./announcements.html',icon:navIcon('announcements'),group:'النظام',requiredPermissions:['announcements.view.self','announcements.view.department','announcements.view.all','announcements.manage'],showInSidebar:true,showInShortcutMenu:false,order:45},
